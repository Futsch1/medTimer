...
class ExportBackupTest : BaseTestHelper() {
    ...
    fun testTriggerExport() {
        ...
        clickOn(com.futsch1.medtimer.feature.ui.R.string.export_csv)
        ...
        openMenu()
        clickOn(com.futsch1.medtimer.feature.ui.R.string.event_data)
        clickOn(com.futsch1.medtimer.feature.ui.R.string.export_pdf)
        device.wait(Until.findObject(By.textContains("Sharing")), 15_000)
        device.pressBack()

        openMenu()
        clickOn(com.futsch1.medtimer.feature.ui.R.string.medicine_data)
        clickOn(com.futsch1.medtimer.feature.ui.R.string.export_csv)
        device.wait(Until.findObject(By.textContains("Sharing")), 15_000)
        device.pressBack()
    ...
    fun testTriggerBackup() {
        ...
        openMenu()
        clickOn(com.futsch1.medtimer.feature.ui.R.string.backup)
