...
class GmsGeofenceRegistrar @Inject constructor(
    ...
    override fun registerHomeGeofence(onSuccess: (() -> Unit)?, onFailure: (() -> Unit)?): Boolean {
        ...
        val geofence = Geofence.Builder()
            .setRequestId(GeofenceRegistrar.GEOFENCE_ID)
    ...
    override fun unregisterHomeGeofence() {
        geofencingClient.removeGeofences(listOf(GeofenceRegistrar.GEOFENCE_ID))
