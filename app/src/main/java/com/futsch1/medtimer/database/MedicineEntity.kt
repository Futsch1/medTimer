...
class MedicineEntity(
    @ColumnInfo(name = "medicineName") @field:Expose var name: String = "",
    ...
    @ColumnInfo(defaultValue = "[]") @field:Expose var refillSizes: MutableList<Double> = mutableListOf(),
    @ColumnInfo(defaultValue = "") @field:Expose var unit: String = "",
