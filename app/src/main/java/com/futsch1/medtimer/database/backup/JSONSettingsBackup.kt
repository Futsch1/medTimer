...
class JSONSettingsBackup(
    private val preferencesDataSource: PreferencesDataSource,
    private val persistentDataDataSource: PersistentDataDataSource
) {

    fun createBackup(): JsonElement {
        val data = preferencesDataSource.preferences.value.toSettingsBackup(persistentDataDataSource.data.value)
    ...
    fun applyBackup(json: String): Boolean {
        return try {
            ...
            data.applyTo(preferencesDataSource, persistentDataDataSource)
            true
