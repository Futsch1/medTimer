...
public class ReminderSchedulerUnitTest {
    ...
    public void test_scheduleEmptyLists() {
        ...
        verify(mock, times(1)).onNextReminder(on(2, 12), medicineWithReminders.medicine, reminder);
    }
    ...
    public void test_scheduleReminders() {
        ...
        verify(mock, times(1)).onNextReminder(on(2, 12), medicineWithReminders1.medicine, reminder2);
        ...
        verify(mock, times(1)).onNextReminder(on(2, 3), medicineWithReminders2.medicine, reminder3);
    }
    ...
    public void test_scheduleWithEvents() {
        ...
        verify(mock, times(1)).onNextReminder(on(2, 12), medicineWithReminders2.medicine, reminder4);
        clearInvocations(mock);
        ...
        verify(mock, times(1)).onNextReminder(on(2, 16), medicineWithReminders1.medicine, reminder1);
        clearInvocations(mock);
        ...
        verify(mock, times(1)).onNextReminder(on(3, 3), medicineWithReminders2.medicine, reminder3);
        clearInvocations(mock);
    ...
    public void test_scheduleSameDayReminder() {
        ...
        verify(mock, times(1)).onNextReminder(on(2, 480), medicineWithReminders.medicine, reminder);
    }
    ...
    public void test_scheduleDifferentMedicineReminder() {
        ...
        verify(mock, times(1)).onNextReminder(on(2, 480), medicineWithReminders1.medicine, reminder1);
    }
    ...
    public void test_scheduleReminderWithOneDayPause() {
        ...
        verify(mock, times(1)).onNextReminder(on(1, 480), medicineWithReminders.medicine, reminder);

        reminderEventList.add(TestHelper.buildReminderEvent(1, on(1, 480).getEpochSecond()));
        when(mockTimeAccess.localDate()).thenReturn(LocalDate.EPOCH.plusDays(1));

        scheduler.schedule(medicineList, reminderEventList);
        verify(mock, times(1)).onNextReminder(on(3, 480), medicineWithReminders.medicine, reminder);
    }
    ...
    public void test_scheduleTwoDayReminderVsOneDay() {
        ...
        scheduler.schedule(medicineList, reminderEventList);
        verify(mock, times(1)).onNextReminder(on(2, 481), medicineWithReminders.medicine, reminder2);
    }
    ...
    public void test_scheduleReminderWithOneDayPauseVsThreeDaysPause() {
        ...
        scheduler.schedule(medicineList, reminderEventList);
        verify(mock, times(1)).onNextReminder(on(1, 481), medicineWithReminders.medicine, reminder2);
        ...
        scheduler.schedule(medicineList, reminderEventList);
        verify(mock, times(1)).onNextReminder(on(5, 480), medicineWithReminders.medicine, reminder);
        ...
        scheduler.schedule(medicineList, reminderEventList);
        verify(mock, times(1)).onNextReminder(on(5, 481), medicineWithReminders.medicine, reminder2);
    }
    ...
    public void test_scheduleCycleInFuture() {
        ...
        reset(mock);
        scheduler.schedule(medicineList, reminderEventList);
        verify(mock, times(1)).onNextReminder(on(8, 480), medicineWithReminders.medicine, reminder);
    }
