...
class ReminderHelperTest {
    ...
    fun testFormatScheduledReminderString() {
        ...
        Mockito.`when`(preferencesDataSourceMock.data).thenReturn(MutableStateFlow(MedTimerPreferences.default()))
        ...
        // Relative date/time
        Mockito.`when`(preferencesDataSourceMock.data).thenReturn(MutableStateFlow(MedTimerPreferences.default().copy(useRelativeDateTime = true)))
        ...
        Mockito.`when`(preferencesDataSourceMock.data).thenReturn(MutableStateFlow(MedTimerPreferences.default().copy(showTakenTimeInOverview = true)))
