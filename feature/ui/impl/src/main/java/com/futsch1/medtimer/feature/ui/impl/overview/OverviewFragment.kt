...
import com.futsch1.medtimer.feature.ui.impl.overview.actions.ActionsMenu
import com.futsch1.medtimer.feature.ui.impl.overview.actions.ActionsVisitor
import com.futsch1.medtimer.feature.ui.impl.overview.actions.MultipleActions
        ...
        override fun onActionItemClicked(mode: ActionMode?, item: MenuItem?): Boolean {
            if (actionsMenu != null) {
                if (item?.itemId == R.id.selectAll) {
                    ...
                    val button = com.futsch1.medtimer.feature.ui.impl.overview.actions.Button.fromId(
