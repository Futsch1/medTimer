package com.futsch1.medtimer.feature.ui.impl.exporters
...
import com.futsch1.medtimer.feature.ui.impl.medicine.LinkedReminderAlgorithms
...
class PDFMedicineExport @AssistedInject constructor(
    ...
    override suspend fun exportInternal(file: File) {
        ...
        simplyPdfDocument.text.write(
            context.getString(R.string.app_name) + " - " + context.getString(R.string.medicine_data),
