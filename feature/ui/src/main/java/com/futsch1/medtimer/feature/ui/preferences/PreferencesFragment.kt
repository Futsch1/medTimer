...
open class PreferencesFragment : PreferenceFragmentCompat() {
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        setupPreferencesLink(
            this,
            "scanned_packages_settings",
            R.id.action_preferencesFragment_to_scannedPackagesFragment
        )
    }
    ...
    private fun setupTheme() {
        ...
        preference?.onPreferenceChangeListener =
            Preference.OnPreferenceChangeListener { _, _ ->
                try {
                    val intent = Intent().setClassName(requireActivity(), "com.futsch1.medtimer.MainActivity")
