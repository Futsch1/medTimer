...
|------------------------------------------------------------|------------------|--------------------------------------------------------------------------------------------|
| [ai-assisted-development.md](ai-assisted-development.md)   | All contributors | How to use AI assistants responsibly — review discipline, boundaries, secrets, attribution |
