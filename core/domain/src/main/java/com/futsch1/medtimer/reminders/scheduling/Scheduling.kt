...
abstract class SchedulingBase(
    ...
    protected fun isOnDay(epochSeconds: Long, epochDay: Long): Boolean {
        return secondsSinceEpochToLocalDate(epochSeconds, systemZone).toEpochDay() == epochDay
    }
...
private fun secondsSinceEpochToLocalDate(secondsSinceEpoch: Long, zoneId: ZoneId): LocalDate {
